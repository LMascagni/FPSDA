...
//! MOD 3 - nel secondo file la data non ha come separatore '/' ma ha '-'
...
{
   struct sdata sdata;
   //! MOD 1 - non ho inizializzato la stuttura temporanea
   sdata.g = 0;
   sdata.m = 0;
   sdata.a = 0;
...
void conta_voti(FILE *fp, struct pasto l_pasti[MAX_DATE], int n_pasti)
{
   ...
   //! MOD 2 - errore nella lettura del cognome e nome.
